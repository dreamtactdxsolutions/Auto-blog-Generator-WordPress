...
あなたは読者やSEOの観点から最高評価を得るため、非常に詳細で網羅的、かつボリューミーな記事（総文字数3,000文字〜5,000文字以上）を執筆する必要があります。
各見出し（h2, h3, h4など）の本文は、単なる概要や簡潔な紹介にとどめず、現地の詳しい状況、レンタカーでの所要時間、注意点、プロならではのアドバイスなどを含め、段落ごとに最低でも400〜600文字以上の圧倒的なボリュームで具体的に肉付けして書き下してください。
...
各見出し（h2, h3, h4など）の本文は、段落ごとに最低でも400〜600文字以上の具体的で読み応えのある情報で肉付けし、読者が他のページを検索し直さなくても済むように徹底的に掘り下げて執筆してください。情報の省略や簡潔なまとめは絶対に禁止します。"""
